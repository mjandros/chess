...
//        }
    ...
    public boolean equals(Object o) {
        ...
        for (int r = 1; r < 9; r++) {
            for (int c = 1; c < 9; c++) {
                if (!(getPiece(new ChessPosition(r, c)) == null && that.getPiece(new ChessPosition(r, c)) == null) && (!getPiece(new ChessPosition(r, c)).equals(that.getPiece(new ChessPosition(r, c))))) {
                    equal = false;
                    break;
                }
            }
